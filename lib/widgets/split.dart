  ...
  double _totalSplitterSize() {
    ...
    if (widget.splitters == null) {
      ...
      for (var splitter in widget.splitters!) {
        totalSize +=
            isHorizontal ? splitter.width ?? 0.0 : splitter.height ?? 0.0;
      }
      return totalSize;
    }
  }
...
// from https://github.com/flutter/devtools/blob/fa5e34c64d2417f5b8c35850dd0b43398bc4309c/packages/devtools_app/lib/src/utils.dart#L641
